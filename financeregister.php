		...
		<form action="fregistration.php" method="post">
			...
			<div class="content">
				...
				<div class="button-container">
					<input type="submit" name="submit" id="button2" value="Register">
				</div>
				<div class="alert">
					<p>Already have an account? <a href="financelogin.php" style="text-decoration: none; color: #fff;">Login</a></p>
				</div>
		</form>
	</div>
</body>
